...
const addCartToMemory = () => {
    localStorage.setItem('herbal-cart', JSON.stringify(cart));
}
const addCartToHTML = () => {
...
const initApp = () => {
    ...
    .then(data => {
        ...
        if(localStorage.getItem('herbal-cart')){
            cart = JSON.parse(localStorage.getItem('herbal-cart'));
            addCartToHTML();
        }
    })
}
